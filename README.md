...
[![Tests](https://img.shields.io/badge/tests-219%20passing-3dba8c.svg)](tests/)
...
tests/        219 tests over the deterministic core
...
pytest -q          # 219 tests, no network or account needed
```

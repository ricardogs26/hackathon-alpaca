...
## 1 · Execution and reconciliation — **1.1, 1.2, 1.3 done in 0.9.0; automated resolution of mismatches (1.5) done in 0.11.0 (2026-09-04)**; 1.4 partly (limit widens by attempts, still in cents)
